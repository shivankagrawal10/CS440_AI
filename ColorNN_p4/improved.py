...
class improved_agent:
        ...
        def __init__(self, img_path, alpha):
                ...
                clustered = k_means.k_means(10,self.img)
                clustered.run()
        ...
        def build_model(self, r_g_b_ind):
                ...
                while i < iterr and (len(losses)<=1 or losses[-1]>10) and self.alpha > .005:
                        ...
                        r = self.rng.integers(4, high=rows-4)
                        c = self.rng.integers(4, high=(cols // 2)-4)
                        #print("Chose", r, c)
...
impr_agent = improved_agent("dog.jpg", .1)
impr_agent.run()
